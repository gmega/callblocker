"""
Django settings for callblocker project.
...
SECRET_KEY = '(tcwr@6rgi(9sb8lb4*@zv0oh*80cmlhl@u(cs4hwr)$5$g8z+'
...
WSGI_APPLICATION = 'callblocker.wsgi.application'
